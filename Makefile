...
$(PROJ_NAME): $(OUT_DIR)/Cmd/Help.o $(OUT_DIR)/Algos.o $(OUT_DIR)/Cmd/Build.o $(OUT_DIR)/Cmd/Test.o $(OUT_DIR)/Cmd/Run.o $(OUT_DIR)/Cmd/New.o $(OUT_DIR)/Cmd/Clean.o $(OUT_DIR)/Cmd/Init.o $(OUT_DIR)/Cmd/Version.o $(OUT_DIR)/BuildConfig.o $(OUT_DIR)/Manifest.o $(OUT_DIR)/Logger.o $(OUT_DIR)/TermColor.o $(OUT_DIR)/main.o
	$(CXX) $(CFLAGS) $^ -o $@
...
$(OUT_DIR)/Cmd/Help.o: src/Cmd/Help.cc src/Cmd/Help.hpp src/Rustify.hpp src/Algos.hpp src/Logger.hpp src/TermColor.hpp
	$(CXX) $(CFLAGS) -c $< -o $@
...
$(OUT_DIR)/Cmd/New.o: src/Cmd/New.cc src/Cmd/New.hpp src/Rustify.hpp src/Algos.hpp src/Logger.hpp src/TermColor.hpp
	$(CXX) $(CFLAGS) -c $< -o $@
...
$(OUT_DIR)/Cmd/Version.o: src/Cmd/Version.cc src/Cmd/Version.hpp src/Rustify.hpp src/Algos.hpp src/Logger.hpp src/TermColor.hpp
	$(CXX) $(CFLAGS) -c $< -o $@
