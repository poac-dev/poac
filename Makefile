...
$(PROJ_NAME): $(OUT_DIR)/Cmd/Help.o $(OUT_DIR)/Algos.o $(OUT_DIR)/Cmd/Build.o \
              ...
              $(OUT_DIR)/Cmd/Clean.o $(OUT_DIR)/Cmd/Init.o \
			  $(OUT_DIR)/Cmd/Version.o $(OUT_DIR)/BuildConfig.o \
			  $(OUT_DIR)/Manifest.o $(OUT_DIR)/Logger.o \
...
$(OUT_DIR)/Cmd/Version.o: src/Cmd/Version.cc src/Cmd/Version.hpp \
                          src/Rustify.hpp src/Algos.hpp src/Logger.hpp \
						  src/TermColor.hpp
	$(CXX) $(CFLAGS) -c $< -o $@
...
$(OUT_DIR)/main.o: src/main.cc src/Cmd/Build.hpp src/Cmd/Test.hpp \
                   src/Cmd/Run.hpp src/Cmd/New.hpp src/Cmd/Clean.hpp \
				   src/Cmd/Init.hpp src/Cmd/Version.hpp src/Rustify.hpp \
				   src/Algos.hpp src/Logger.hpp src/TermColor.hpp \
				   src/Cmd/Global.hpp
	$(CXX) $(CFLAGS) -c $< -o $@
...
$(OUT_DIR)/tests/test_BuildConfig.o: src/BuildConfig.cc src/BuildConfig.hpp \
                                     src/Rustify.hpp src/Algos.hpp \
									 src/Logger.hpp src/TermColor.hpp
