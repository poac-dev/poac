...
BOOST_AUTO_TEST_CASE( poac_core_sat_test1 )
{
    ...
    const auto result = sat::solve(clauses, 2);

    BOOST_CHECK( result.is_ok() );
    BOOST_CHECK( result.unwrap() == std::vector<int>({ -1, 2 }) );
}
...
BOOST_AUTO_TEST_CASE( poac_core_sat_test2 )
{
    ...
    const auto result = sat::solve(clauses, 4);

    BOOST_CHECK( result.is_ok() );
    BOOST_CHECK( result.unwrap() == std::vector<int>({ -1, 2, 3, -4 }) );
}
...
BOOST_AUTO_TEST_CASE( poac_core_sat_test3 )
{
    ...
    const auto result = sat::solve(clauses, 6);

    BOOST_CHECK( result.is_ok() );
    BOOST_CHECK( result.unwrap() == std::vector<int>({ 1, 2, 3, -4, 5, 6 }) );
}
...
BOOST_AUTO_TEST_CASE( poac_core_sat_test4 )
{
    ...
    const auto result = sat::solve(clauses, 5);

    BOOST_CHECK( result.is_ok() );
    BOOST_CHECK( result.unwrap() == std::vector<int>({ 1, 2, 3, 4, 5 }) );
}
...
//            { 63, -86, -98 }
//    };
//    const auto result = sat::solve(clauses, 100);
//
//    BOOST_CHECK( result.is_err() );
//}
