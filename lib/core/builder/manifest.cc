...
inline Vec<String>
gather_conan_defines(const boost::property_tree::ptree& pt) {
  return gather_conan_conf(pt, "defines", "-D");
}

inline Vec<String>
gather_conan_includes(const boost::property_tree::ptree& pt) {
  return gather_conan_conf(pt, "include_paths", "-I");
}

inline Vec<String>
gather_conan_libdirs(const boost::property_tree::ptree& pt) {
  return gather_conan_conf(pt, "lib_paths", "-L");
}

inline Vec<String>
gather_conan_libraries(const boost::property_tree::ptree& pt) {
