...
operator"" _bold_green(const char* str, std::size_t len) {
  return to_color2(
      bold_v<char>, green_v<char>, std::basic_string<char>(str, len)
  );
}
inline std::basic_string<wchar_t>
operator"" _bold_green(const wchar_t* str, std::size_t len) {
  return to_color2(
      bold_v<wchar_t>, green_v<wchar_t>, std::basic_string<wchar_t>(str, len)
  );
}
inline std::basic_string<char8_t>
operator"" _bold_green(const char8_t* str, std::size_t len) {
  return to_color2(
      bold_v<char8_t>, green_v<char8_t>, std::basic_string<char8_t>(str, len)
  );
}
inline std::basic_string<char16_t>
operator"" _bold_green(const char16_t* str, std::size_t len) {
  return to_color2(
      bold_v<char16_t>, green_v<char16_t>, std::basic_string<char16_t>(str, len)
  );
}
inline std::basic_string<char32_t>
operator"" _bold_green(const char32_t* str, std::size_t len) {
  return to_color2(
      bold_v<char32_t>, green_v<char32_t>, std::basic_string<char32_t>(str, len)
  );
}
...
operator"" _bold_yellow(const char* str, std::size_t len) {
  return to_color2(
      bold_v<char>, yellow_v<char>, std::basic_string<char>(str, len)
  );
}
inline std::basic_string<wchar_t>
operator"" _bold_yellow(const wchar_t* str, std::size_t len) {
  return to_color2(
      bold_v<wchar_t>, yellow_v<wchar_t>, std::basic_string<wchar_t>(str, len)
  );
}
inline std::basic_string<char8_t>
operator"" _bold_yellow(const char8_t* str, std::size_t len) {
  return to_color2(
      bold_v<char8_t>, yellow_v<char8_t>, std::basic_string<char8_t>(str, len)
  );
}
inline std::basic_string<char16_t>
