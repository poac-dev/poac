...
namespace poac::opts {
    namespace _install {
        void stream_deps(YAML::Emitter& out, const core::deper::resolve::Activated& deps) {
        ...
        void create_lock_file(const std::string& timestamp, const core::deper::resolve::Activated& activated_deps) {
            // Create a poac.lock
        ...
        void fetch_packages( // TODO: そもそも関数が長くてキモい．
                const core::deper::resolve::Backtracked& deps,
                const bool quite,
                const bool verbose)
        {
        ...
        core::deper::resolve::Package<core::deper::resolve::Name, core::deper::resolve::Interval, core::deper::resolve::Source>
