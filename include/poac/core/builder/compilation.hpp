...
//
//
//        // TODO: 一旦依存関係を集めて，一気に変換だとメモリが保たない．なので，インクリメンタルに変換するのが良い．
//
//
...
//        }
//
//        // TODO: これとかいらないし，obj_files_pathは，builderの中で完結できるはず．
//        // TODO: builder::compileの結果をそのまま，obj_files_pathとして生成しているみたい．
...
//
//
//        int build(const bool verbose) {
//            return EXIT_SUCCESS;
//        }
//
//        int run(const bool verbose) {
//            return EXIT_SUCCESS;
//        }
//
//        // TODO: こっちで再帰探索した方が良さそう．
...
//        explicit Builder(const boost::filesystem::path& base_dir)
//        {
//            namespace yaml = io::file::yaml;
//
