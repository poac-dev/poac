...
* Compilers which support [C++20](https://en.cppreference.com/w/cpp/20) with modules
  <!-- * `GCC`: `11` or later -->
  * `Clang`: `16` or later
...
* [`CMake`](https://gitlab.kitware.com/cmake/cmake): [`3.26`](https://gitlab.kitware.com/cmake/cmake/-/tree/v3.21.6) or later
* [`Ninja`](https://github.com/ninja-build/ninja): `1.11` or later
