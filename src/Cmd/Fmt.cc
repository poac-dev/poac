...
static constexpr Arr<StringRef, 14> EXTENSIONS{"c",   "c++", "cc",  "cpp", "cu",
                                               "cuh", "cxx", "h",   "h++", "hh",
                                               "hpp", "hxx", "ixx", "cppm"};
static constexpr Arr<StringRef, 2> PATTERNS{"{}/*.{}", "{}/**/*.{}"};

static void fmt_impl(const Path& base_dir, Vec<Path>& targets) {
